...
import {
  LayoutDashboard, Wrench, Users, FileText, DollarSign,
  Menu, X, LogOut, Bell, ChevronRight, Droplets,
} from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { href: '/dashboard/provider/earnings', label: 'Earnings', icon: DollarSign },
]
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between h-[72px] px-6 border-b border-gray-100">
            <Link href="/dashboard/provider" className="flex items-center gap-2.5 group">
              ...
              <div>
                ...
                <span className="block text-[10px] font-medium text-gray-400 -mt-0.5">Provider Portal</span>
              </div>
            </Link>
            <button
          ...
          <div className="px-3 py-4 border-t border-gray-100">
            <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[13px] font-semibold text-gray-900 truncate">AquaDrill Solutions</p>
                <p className="text-[11px] text-gray-400 truncate">info@aquadrill.co.za</p>
              </div>
        ...
        <header className="sticky top-0 z-30 h-[72px] bg-white/80 backdrop-blur-md border-b border-gray-200/60 flex items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <div className="hidden sm:flex items-center gap-3 pl-3 ml-1 border-l border-gray-200/60">
              ...
              <div>
                <span className="text-[13px] font-semibold text-gray-800 block leading-tight">AquaDrill</span>
                <span className="text-[11px] text-gray-400">Service Provider</span>
              </div>
            </div>
          </div>
        </header>
